...
// Sequence_create() creates a new (empty) Sequence
struct Sequence *Sequence_create(void);

// Sequence_length(seq) retrieves the number of items in seq
...
// Sequence_item_at(seq, pos) retrieves the item in seq at the given pos
